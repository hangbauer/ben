...
@section('content')
	<a href="{{ url('invoice/create') }}" class="btn btn-primary"><i class="fa fa-fw fa-plus"></i> Tambah</a>
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									<label for="invoiceno">Nomor Invoice</label>
...
@section('scripts')
	...
	<script>
		...
		function searchList(){
	        var req = $.ajax({
	            type: "POST",
	            url: "{{ url('invoice/search-table-list') }}",
	            data: {
